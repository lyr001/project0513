...
export function material_database_mct() {
  return new MaterialDatabase({path: '../../../GateMaterials.db'});
}
...
//   execute: 'Verbose.mac'
// });
export function data_output_mct() {
...
// });
export function acquisition_mct() {
